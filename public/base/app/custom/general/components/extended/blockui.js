...
var KBlockUIDemo = {
    init: function () {
        $("#k_blockui_1_1").click(function () {
            KApp.block("#k_blockui_1_content", {}), setTimeout(function () {
                KApp.unblock("#k_blockui_1_content")
            }, 2e3)
        }), $("#k_blockui_1_2").click(function () {
            KApp.block("#k_blockui_1_content", {overlayColor: "#000000", state: "primary"}), setTimeout(function () {
                KApp.unblock("#k_blockui_1_content")
            }, 2e3)
            ...
            KApp.block("#k_blockui_2_portlet", {}), setTimeout(function () {
                KApp.unblock("#k_blockui_2_portlet")
            }, 2e3)
        }), $("#k_blockui_2_2").click(function () {
            KApp.block("#k_blockui_2_portlet", {overlayColor: "#000000", state: "primary"}), setTimeout(function () {
                KApp.unblock("#k_blockui_2_portlet")
            }, 2e3)
            ...
            KApp.blockPage(), setTimeout(function () {
                KApp.unblockPage()
            }, 2e3)
        }), $("#k_blockui_3_2").click(function () {
            KApp.blockPage({overlayColor: "#000000", state: "primary"}), setTimeout(function () {
                KApp.unblockPage()
            }, 2e3)
            ...
            KApp.block("#k_blockui_4_1_modal .modal-content", {}), setTimeout(function () {
