...
<div id="k_offcanvas_toolbar_profile" class="k-offcanvas-panel">
    ...
    <div class="k-offcanvas-panel__body">
        ...
        <div class="k-offcanvas-panel__section k-margin-t-50"> Sales Stats </div>
        ...
        <div class="k-offcanvas-panel__section k-margin-t-50"> Top Products </div>
        <div class="k-widget-4">
            <div class="k-widget-4__items">
                <div class="k-widget-4__item">
                    ...
                    <div class="k-widget-4__item-content">
                        <div class="k-widget-4__item-price"> <span class="k-widget-4__item-badge">$</span> <span class="k-widget-4__item-number">2,830</span> </div>
                    </div>
                </div>
                <div class="k-widget-4__item">
                    <div class="k-widget-4__item-content">
                    ...
                    <div class="k-widget-4__item-content">
                        <div class="k-widget-4__item-price"> <span class="k-widget-4__item-badge">$</span> <span class="k-widget-4__item-number">4,975</span> </div>
                    </div>
                </div>
                <div class="k-widget-4__item">
                    <div class="k-widget-4__item-content">
                    ...
                    <div class="k-widget-4__item-content">
                        <div class="k-widget-4__item-price"> <span class="k-widget-4__item-badge">$</span> <span class="k-widget-4__item-number">3.594</span> </div>
                    </div>
                </div>
            </div>
        </div>
