...
<div id="kt_offcanvas_toolbar_profile" class="kt-offcanvas-panel" style="opacity: 1;">
    ...
    <div class="kt-offcanvas-panel__body kt-scroll ps ps--active-y" style="height: 784px; overflow: hidden;">
        ...
        <div class="kt-widget-1">
            <div class="kt-widget-1__body-items">
                <div class="kt-widget-1__body-item">
                    <div class="kt-widget-1__body-item-info">
                        <a href="#">
                            <div class="kt-widget-1__body-item-title">HTML 5 Templates</div>
                        </a>
                        <div class="kt-widget-1__body-item-desc">Font-end,Admin &amp; Email</div>
                    </div>
                    <div class="kt-widget-1__body-item-stats">
                        <div class="kt-widget-1__body-item-value">+79%</div>
                        <div class="kt-widget-1__body-item-progress">
                            <div class="progress">
                ...
                <div class="kt-widget-1__body-item">
                    <div class="kt-widget-1__body-item-info">
                        <a href="#">
                            <div class="kt-widget-1__body-item-title">Wordpress Themes</div>
                        </a>
                        <div class="kt-widget-1__body-item-desc">eCommerce Website, Plugin</div>
                    </div>
                    <div class="kt-widget-1__body-item-stats">
                        <div class="kt-widget-1__body-item-value">+21%</div>
                        <div class="kt-widget-1__body-item-progress">
                            <div class="progress">
                ...
                <div class="kt-widget-1__body-item">
                    <div class="kt-widget-1__body-item-info">
                        <a href="#">
                            <div class="kt-widget-1__body-item-title">eCommerce Websites</div>
                        </a>
                        <div class="kt-widget-1__body-item-desc">Shops, Fasion wep sites &amp; atc</div>
                    </div>
                    <div class="kt-widget-1__body-item-stats">
                        <div class="kt-widget-1__body-item-value">-16%</div>
                        <div class="kt-widget-1__body-item-progress">
                            <div class="progress">
                ...
                <div class="kt-widget-1__body-item">
                    <div class="kt-widget-1__body-item-info">
                        <a href="#">
                            <div class="kt-widget-1__body-item-title">UI/UX Design</div>
                        </a>
                        <div class="kt-widget-1__body-item-desc">Evrything you ever imagine</div>
                    </div>
                    <div class="kt-widget-1__body-item-stats">
                        <div class="kt-widget-1__body-item-value">+4%</div>
                        <div class="kt-widget-1__body-item-progress">
                            <div class="progress">
                ...
                <div class="kt-widget-4__item">
                    ...
                    <div class="kt-widget-4__itek-content">
                        <div class="kt-widget-4__item-price">
                            <span class="kt-widget-4__itek-badge">$</span>
        ...
        <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 784px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 300px;"></div></div></div>
</div>
