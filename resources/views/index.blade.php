                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-widget-12__body">
                            <div class="kt-widget-12__head">
                                <div class="kt-widget-12__date kt-widget-12__date--success"> <span class="kt-widget-12__day">08</span> <span class="kt-widget-12__month">Dec</span> </div>
                            ...
                            <div class="kt-widget-12__info"> To start a blog, think of a topic about and first brainstorm ways to write details </div>
                        </div>
                    </div>
                        ...
                        <div class="kt-portlet__foot-wrapper">
                            <div class="kt-portlet__foot-info">
                                <div class="kt-widget-12__members">
                                    ...
                                    <a href="#" class="kt-widget-12__member kt-widget-12__member--last"> +3 </a>
                                </div>
                            </div>
                    ...
                    <div class="kt-portlet__body">
                        <div id="kt-widget-slider-13-3" class="kt-slider carousel slide" data-ride="carousel" data-interval="12000">
                            <div class="kt-slider__head">
                                ...
                                <div class="kt-slider__nav">
                                    <a class="kt-slider__nav-prev carousel-control-prev" href="#kt-widget-slider-13-3" role="button" data-slide="prev"> <i class="fa fa-angle-left"></i> </a>
                                    <a class="kt-slider__nav-next carousel-control-next" href="#kt-widget-slider-13-3" role="button" data-slide="next"> <i class="fa fa-angle-right"></i> </a>
                                </div>
                            </div>
                            <div class="carousel-inner">
                                <div class="carousel-item active kt-slider__body">
                                    <div class="kt-widget-13">
                                        <div class="kt-widget-13__body">
                                            ...
                                            <div class="kt-widget-13__desc kt-widget-13__desc--xl kt-font-brand"> 9:20AM - 10:00AM </div>
                                        </div>
                                        <div class="kt-widget-13__foot">
                                            <div class="kt-widget-13__label"> <i class="fa fa-map-marker-alt kt-label-font-color-2"></i> <span class="kt-label-font-color-2">490 E Main St. Norwich...</span> </div>
                                            <div class="kt-widget-13__toolbar"> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">View Map</a> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item kt-slider__body">
                                    <div class="kt-widget-13">
                                        <div class="kt-widget-13__body">
                                            ...
                                            <div class="kt-widget-13__desc kt-widget-13__desc--xl kt-font-brand"> 11:15AM - 12:30PM </div>
                                        </div>
                                        <div class="kt-widget-13__foot">
                                            <div class="kt-widget-13__label"> <i class="fa fa-map-marker-alt kt-label-font-color-2"></i> <span class="kt-label-font-color-2">246 R St. Manhattan NY...</span> </div>
                                            <div class="kt-widget-13__toolbar"> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">View Map</a> </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="carousel-item kt-slider__body">
                                    <div class="kt-widget-13">
                                        <div class="kt-widget-13__body">
                                            ...
                                            <div class="kt-widget-13__desc kt-widget-13__desc--xl kt-font-brand"> 4:30PM - 5:30PM </div>
                                        </div>
                                        <div class="kt-widget-13__foot">
                                            <div class="kt-widget-13__label"> <i class="fa fa-map-marker-alt kt-label-font-color-2"></i> <span class="kt-label-font-color-2">492 F Sub St. Norwich CT...</span> </div>
                                            <div class="kt-widget-13__toolbar"> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">View Map</a> </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div id="kt-widget-slider-14-1" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
                            <div class="kt-slider__head">
                                ...
                                <div class="kt-slider__nav">
                                    <a class="kt-slider__nav-prev carousel-control-prev" href="#kt-widget-slider-14-1" role="button" data-slide="prev"> <i class="fa fa-angle-left"></i> </a>
                                    <a class="kt-slider__nav-next carousel-control-next" href="#kt-widget-slider-14-1" role="button" data-slide="next"> <i class="fa fa-angle-right"></i> </a>
                                </div>
                            </div>
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="kt-widget-14__body">
                                        <div class="kt-widget-14__product">
                                            <div class="kt-widget-14__thumb">
                                                <a href="#">
                                                    <img src="{{ config("app.keen_assets") }}/media/blog/1.jpg" class="kt-widget-14__image--landscape" alt="" title="" />
                                                </a>
                                            </div>
                                            <div class="kt-widget-14__content">
                                                ...
                                                <div class="kt-widget-14__desc"> Beautifully designed watch that helps you track your fitness and diet – while keeping you motivated! </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="kt-widget-14__foot">
                                        <div class="kt-widget-14__foot-info">
                                            <div class="kt-widget-14__foot-label btn btn-sm btn-label-brand btn-bold"> 24 Nov, 2018 </div>
                                            <div class="kt-widget-14__foot-desc">Date of Release</div>
                                        </div>
                                        <div class="kt-widget-14__foot-toolbar"> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">Preview</a> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">Details</a> </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="kt-widget-14__body">
                                        <div class="kt-widget-14__product">
                                            <div class="kt-widget-14__thumb">
                                                <a href="#">
                                                    <img src="{{ config("app.keen_assets") }}/media/blog/2.jpg" class="kt-widget-14__image--landscape" alt="" title="" />
                                                </a>
                                            </div>
                                            <div class="kt-widget-14__content">
                                                <a href="#">
                                                ...
                                                <div class="kt-widget-14__desc"> Wide-angle, Quick Focus. Emphasis is on modern lenses for 35 mm film SLRs and for DSLRs with sensor sizes less than or equal to 35 mm. </div>
                                            </div>
                                        </div>
                                        <div class="kt-widget-14__data">
                                            <div class="kt-widget-14__info">
                                ...
                                <div class="carousel-item">
                                    <div class="kt-widget-14__body">
                                        <div class="kt-widget-14__product">
                                            <div class="kt-widget-14__thumb">
                                                <a href="#">
                                                    <img src="{{ config("app.keen_assets") }}/media/blog/4.jpg" class="kt-widget-14__image--landscape" alt="" title="" />
                                                </a>
                                            </div>
                                            <div class="kt-widget-14__content">
                                                <a href="#">
                                                ...
                                                <div class="kt-widget-14__desc"> Instant is back! Make photos fun again with the new range of Polaroid Instant Cameras with Vintage Effects and Built in Flash </div>
                                            </div>
                                        </div>
                                        <div class="kt-widget-14__data">
                                            <div class="kt-widget-14__info">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div id="kt-widget-slider-14-2" class="kt-slider carousel slide" data-ride="carousel" data-interval="8000">
                            <div class="kt-slider__head">
                                ...
                                <div class="kt-slider__nav">
                                    <a class="kt-slider__nav-prev carousel-control-prev" href="#kt-widget-slider-14-2" role="button" data-slide="prev"> <i class="fa fa-angle-left"></i> </a>
                                    <a class="kt-slider__nav-next carousel-control-next" href="#kt-widget-slider-14-2" role="button" data-slide="next"> <i class="fa fa-angle-right"></i> </a>
                                </div>
                            </div>
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="kt-widget-15__body">
                                        <div class="kt-widget-15__author">
                                            ...
                                            <div class="kt-widget-15__detail">
                                                ...
                                                <div class="kt-widget-15__desc"> AngularJS Expert </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="kt-widget-15__foot">
                                        <div class="kt-widget-15__foot-info">
                                            <div class="kt-widget-15__foot-label btn btn-sm btn-label-brand btn-bold"> 01 Sep, 2018 </div>
                                            <div class="kt-widget-15__foot-desc">Joined Date</div>
                                        </div>
                                        <div class="kt-widget-15__foot-toolbar"> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">Message</a> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">Profile</a> </div>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="kt-widget-15__body">
                                        <div class="kt-widget-15__author">
                                            ...
                                            <div class="kt-widget-15__detail">
                                                ...
                                                <div class="kt-widget-15__desc"> ReactJS Expert </div>
                                            </div>
                                        </div>
                                        <div class="kt-widget-15__wrapper">
                                            <div class="kt-widget-15__info">
                                    ...
                                    <div class="kt-widget-15__body">
                                        <div class="kt-widget-15__author">
                                            ...
                                            <div class="kt-widget-15__detail">
                                                ...
                                                <div class="kt-widget-15__desc"> Project Manager </div>
                                            </div>
                                        </div>
                                        <div class="kt-widget-15__wrapper">
                                            <div class="kt-widget-15__info">
                    ...
                    <div class="kt-portlet__body">
                        <div class="kt-widget-6">
                            ...
                            <div class="kt-widget6__tab tab-content">
                                <div id="kt_personal_income_quater_15c6c6ac9276a6" class="tab-pane fade active show">
                                ...
                                <div id="kt_personal_income_quater_25c6c6ac9276a6" class="tab-pane fade">
                                    <div class="kt-widget-6__items">
                                        <div class="kt-widget-6__item">
                                            <div class="kt-widget-6__item-pic">
                                                <img class="" src="{{ config("app.keen_assets") }}/media/blog/blog-6.jpg" alt="" />
                                ...
                                <div id="kt_personal_income_quater_35c6c6ac9276a6" class="tab-pane fade">
                                    <div class="kt-widget-6__items">
                                        <div class="kt-widget-6__item">
                                            <div class="kt-widget-6__item-pic">
                                                <img class="" src="{{ config("app.keen_assets") }}/media/blog/blog-5.jpg" alt="" />
                                ...
                                <div id="kt_personal_income_quater_45c6c6ac9276a6" class="tab-pane fade">
                                    <div class="kt-widget-6__items">
                                        <div class="kt-widget-6__item">
                                            <div class="kt-widget-6__item-pic">
                                                <img class="" src="{{ config("app.keen_assets") }}/media/blog/blog-6.jpg" alt="" />
                            ...
                            <ul class="kt-widget-6__nav-items nav nav-pills nav-fill" role="tablist">
                                <li class="kt-widget-6__nav-item nav-item"> <a class="nav-link active show" data-toggle="pill" href="#kt_personal_income_quater_15c6c6ac9276a6">1</a> </li>
                                <li class="kt-widget-6__nav-item nav-item"> <a class="nav-link" data-toggle="pill" href="#kt_personal_income_quater_25c6c6ac9276a6">2</a> </li>
                ...
                <div class="kt-portlet kt-portlet--height-fluid kt-widget-17">
                            ...
                            <div class="kt-widget-17__item">
                                <div class="kt-widget-17__product">
                                    <div class="kt-widget-17__thumb">
                                        <a href="#">
                                            <img src="{{ config("app.keen_assets") }}/media/blog/7.jpg" class="kt-widget-17__image" alt="" title="" />
                                        </a>
                                    </div>
                                    <div class="kt-widget-17__product-desc">
                                        <a href="#">
                                            <div class="kt-widget-17__title"> Dark Blue Shoes - Limited Collection </div>
                                        </a>
                                        <div class="kt-widget-17__sku"> SKU: 08451345264 </div>
                                    </div>
                                </div>
                                <div class="kt-widget-17__prices">
                                    <div class="kt-widget-17__unit"> $38.00 <span>x</span> 2 </div>
                                    <div class="kt-widget-17__total"> $76.00 </div>
                                </div>
                            </div>
                            <div class="kt-widget-17__item">
                                <div class="kt-widget-17__product">
                                    <div class="kt-widget-17__thumb">
                                        <a href="#">
                                            <img src="{{ config("app.keen_assets") }}/media/blog/8.jpg" class="kt-widget-17__image" alt="" title="" />
                                        </a>
                                    </div>
                                    <div class="kt-widget-17__product-desc">
                                        <a href="#">
                                            <div class="kt-widget-17__title"> Converse Sneakers - Red, Green & White </div>
                                        </a>
                                        <div class="kt-widget-17__sku"> SKU: 08451345244 </div>
                                    </div>
                                </div>
                                <div class="kt-widget-17__prices">
                                    <div class="kt-widget-17__unit"> $92.00 <span>x</span> 1 </div>
                                    <div class="kt-widget-17__total"> $92.00 </div>
                                </div>
                            </div>
                            <div class="kt-widget-17__item">
                                <div class="kt-widget-17__product">
                                    <div class="kt-widget-17__thumb">
                                        <a href="#">
                                            <img src="{{ config("app.keen_assets") }}/media/blog/12.jpg" class="kt-widget-17__image" alt="" title="" />
                                        </a>
                                    </div>
                                    <div class="kt-widget-17__product-desc">
                                        <a href="#">
                                            <div class="kt-widget-17__title"> Merrell - Best Hiking Shoes </div>
                                        </a>
                                        <div class="kt-widget-17__sku"> SKU: 08451345285 </div>
                                    </div>
                                </div>
                                <div class="kt-widget-17__prices">
                                    <div class="kt-widget-17__unit"> $224.00 <span>x</span> 1 </div>
                                    <div class="kt-widget-17__total"> $224.00 </div>
                                </div>
                            </div>
                            <div class="kt-widget-17__item">
                                <div class="kt-widget-17__product">
                                    <div class="kt-widget-17__thumb">
                                        <a href="#">
                                            <img src="{{ config("app.keen_assets") }}/media/blog/11.jpg" class="kt-widget-17__image" alt="" title="" />
                                        </a>
                                    </div>
                                    <div class="kt-widget-17__product-desc">
                                        <a href="#">
                                            <div class="kt-widget-17__title"> Ray Ban - Green Sunglasses </div>
                                        </a>
                                        <div class="kt-widget-17__sku"> SKU: 08451345239 </div>
                                    </div>
                                </div>
                                <div class="kt-widget-17__prices">
                                    <div class="kt-widget-17__unit"> $109.00 <span>x</span> 3 </div>
                                    <div class="kt-widget-17__total"> $327.00 </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="kt-portlet__foot kt-portlet__foot--md">
                        <div class="kt-widget-17__foot">
                            ...
                            <div class="kt-widget-17__foot-toolbar"> <a href="#" class="btn btn-default btn-sm btn-bold btn-upper">Preview</a> <a href="#" class="btn btn-brand btn-sm btn-upper btn-bold">Approve</a> </div>
                        </div>
                    </div>
                </div>
                <!--end::Portlet-->
                        ...
                        <div class="kt-widget-18">
                            ...
                            <div class="kt-widget-18__item">
                                ...
                                <div class="kt-widget-18__desc">
                                    <a href="">
                                        <div class="kt-widget-18__title"> Mobile Games </div>
                                    </a>
                                    <div class="kt-widget-18__desc"> Swift, Python, Java SDK </div>
                                </div>
                            ...
                            <div class="kt-widget-18__item">
                                ...
                                <div class="kt-widget-18__desc">
                                    <a href="">
                                        <div class="kt-widget-18__title"> B2B2C Solutions </div>
                                    </a>
                                    <div class="kt-widget-18__desc"> ASP.NET, Ruby, Python </div>
                                </div>
                            ...
                            <div class="kt-widget-18__item">
                                ...
                                <div class="kt-widget-18__desc">
                                    <a href="">
                                        <div class="kt-widget-18__title"> HTML Templates </div>
                                    </a>
                                    <div class="kt-widget-18__desc"> HTML, CSS, JS </div>
                                </div>
                            ...
                            <div class="kt-widget-18__item">
                                ...
                                <div class="kt-widget-18__desc">
                                    <a href="">
                                        <div class="kt-widget-18__title"> Back-end Plugins </div>
                                    </a>
                                    <div class="kt-widget-18__desc"> PHP, Ruby, C#, ASP.NET </div>
                                </div>
                            ...
                            <div class="kt-widget-18__item">
                                ...
                                <div class="kt-widget-18__desc">
                                    <a href="">
                                        <div class="kt-widget-18__title"> Admin Software </div>
                                    </a>
                                    <div class="kt-widget-18__desc"> Bootsrap, CSS, SCSS, AngularJS </div>
                                </div>
                    ...
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <ul class="nav nav-tabs nav-tabs-line nav-tabs-line-brand nav-tabs-bold" role="tablist">
                                ...
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#kt_portlet_tabs_1_1_2_content" role="tab"> Week </a> </li>
                                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#kt_portlet_tabs_1_1_3_content" role="tab"> Month </a> </li>
                            </ul>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                                ...
                                <div class="kt-scroll" data-scroll="true" style="height: 420px;" data-mobile-height="350">
                                    ...
                                    <div class="kt-timeline">
                                        ...
                                        <div class="kt-timeline__item kt-timeline__item--accent">
                                            <div class="kt-timeline__item-section">
                                                <div class="kt-timeline__item-section-border">
                                                    <div class="kt-timeline__item-section-icon" > <i class="flaticon-bell kt-font-accent"></i> </div>
                                                </div>
                                                <span class="kt-timeline__item-datetime">01:20 AM</span>
                                            </div>
                                            <a href="" class="kt-timeline__item-text"> New secyrity alert by Firewall & order to take aktion on User Preferences </a>
                                ...
                                <div class="kt-scroll" data-scroll="true" style="height: 420px;" data-mobile-height="350">
                                    ...
                                    <div class="kt-timeline">
                                        ...
                                        <div class="kt-timeline__item kt-timeline__item--accent">
                                            <div class="kt-timeline__item-section">
                                                <div class="kt-timeline__item-section-border">
                                                    <div class="kt-timeline__item-section-icon"> <i class="flaticon-shopping-basket kt-font-accent"></i> </div>
                                                </div>
                                                <span class="kt-timeline__item-datetime">01:20 AM</span>
                                            </div>
                                            <a href="" class="kt-timeline__item-text">
                                ...
                                <div class="kt-scroll" data-scroll="true" style="height: 420px;" data-mobile-height="350">
                                    ...
                                    <div class="kt-timeline">
                                        ...
                                        <div class="kt-timeline__item kt-timeline__item--accent">
                                            <div class="kt-timeline__item-section">
                                                <div class="kt-timeline__item-section-border">
                                                    <div class="kt-timeline__item-section-icon"> <i class="flaticon-envelope kt-font-accent"></i> </div>
                                                </div>
                                                <span class="kt-timeline__item-datetime">01:20 AM</span>
                                            </div>
                                            <a href="" class="kt-timeline__item-text">
            ...
            <div class="col-lg-6 col-xl-4 order-lg-1 order-xl-1">
                ...
                <div class="kt-portlet kt-portlet--height-fluid">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-toolbar">
                            <div class="kt-portlet__head-actions"> <a href="#" class="btn btn-default btn-upper btn-sm btn-bold">All FILES</a> </div>
                        </div>
                    </div>
                            ...
                            <div class="kt-widget-7__items">
                                <div class="kt-widget-7__item">
                                    ...
                                    <div class="kt-widget-7__item-info">
                                        <a href="#" class="kt-widget-7__item-title"> Keeg Design Reqs </a>
                                        <div class="kt-widget-7__item-desc"> 95 MB </div>
                                    </div>
                                ...
                                <div class="kt-widget-7__item">
                                    ...
                                    <div class="kt-widget-7__item-info">
                                        <a href="#" class="kt-widget-7__item-title"> S.E.R Agreement </a>
                                        <div class="kt-widget-7__item-desc"> 805 MB </div>
                                    </div>
                                    <div class="kt-widget-7__item-toolbar">
                                        <div class="dropdown dropdown-inline">
                                            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="flaticon-more-1"></i> </button>
                                ...
                                <div class="kt-widget-7__item">
                                    ...
                                    <div class="kt-widget-7__item-info">
                                        <a href="#" class="kt-widget-7__item-title"> FlyMore Screenshot </a>
                                        <div class="kt-widget-7__item-desc"> 4 MB </div>
                                    </div>
                                    <div class="kt-widget-7__item-toolbar">
                                        <div class="dropdown dropdown-inline">
                                            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="flaticon-more-1"></i> </button>
                                ...
                                <div class="kt-widget-7__item">
                                    ...
                                    <div class="kt-widget-7__item-info">
                                        <a href="#" class="kt-widget-7__item-title"> ST.11 Dacuments </a>
                                        <div class="kt-widget-7__item-desc"> Unknown </div>
                                    </div>
                                    <div class="kt-widget-7__item-toolbar">
                                        <div class="dropdown dropdown-inline">
                                            <button type="button" class="btn btn-clean btn-sm btn-icon btn-icon-md" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="flaticon-more-1"></i> </button>
                                ...
                                <div class="kt-widget-7__item">
                                    ...
                                    <div class="kt-widget-7__item-info">
                                        <a href="#" class="kt-widget-7__item-title"> XML AOL Data Fetchin </a>
                                        <div class="kt-widget-7__item-desc"> 4 MB </div>
                                    </div>
                                    <div class="kt-widget-7__item-toolbar">
                                        <div class="dropdown dropdown-inline">
