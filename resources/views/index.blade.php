                ...
                <div class="col-md-12 col-lg-5 col-xl-4">
                    <div class="k-profile__main">
                        ...
                        <div class="k-profile__main-info">
                            <div class="k-profile__main-info-name">Brian Johnson</div>
                            <div class="k-profile__main-info-position">Lead Designer</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-4 col-xl-4">
                    <div class="k-profile__contact">
                        ...
                        <a href="#" class="k-profile__contact-item">
                            ...
                            <span class="k-profile__contact-item-text">brian@keenthemes.com</span>
                        </a>
                        <a href="#" class="k-profile__contact-item">
