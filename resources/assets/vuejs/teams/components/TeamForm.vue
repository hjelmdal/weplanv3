...
<template>
    ...
    <div class="kt-section kt-form__section--first">
        ...
        <div class="form-group kt-form__group row">
            ...
            <div class="col-lg-6 col-md-9 col-sm-12">
                <input name="max_players" :class="errors.max_players ? 'is-invalid': ''" class="form-control kt-input" id="max_players" type="number" placeholder="20" v-model="form.max_players">
