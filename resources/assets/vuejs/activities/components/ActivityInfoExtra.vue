        ...
        <div class="card-body text-center">
            <ul class="nav nav-pills nav-tabs-btn" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#tab0" role="tab">
                        ...
                        <span class="nav-link-title">info</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a :class="{'disabled':!activity.my_activity}" class="nav-link" data-toggle="tab" href="#tab1" role="tab">
                        <span class="nav-link-icon"><i class="flaticon-information"></i></span>
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="tab0" role="tabpanel">
                    <div class="kt-widget17 kt-mt-60">
